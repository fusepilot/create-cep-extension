...
/**
 * states constants for the window types supported by the CSXS infrastructure.
 */
...
/**
 * @class SystemPath
 * states operating-system-specific location constants for use in the
...
/**
 * @class RGBColor
 * states an RGB color with red, green, blue, and alpha values.
...
/**
 * @class GradientStop
 * states gradient stop information.
 *
...
/**
 * @class GradientColor
 * states gradient color information.
 *
...
/**
 * @class UIColor
 * states color information, including the type, anti-alias level, and specific color
...
/**
 * @class AppSkinInfo
 * states window-skin properties, such as color and font. All color parameter values are \c #UIColor objects except that systemHighlightColor is \c #RGBColor object.
 *
 ...
 * states information about the environment in which the extension is loaded.
 *
 ...
 * states information about the host capabilities.
 *
 ...
 * states flyout menu item status
 *
 * Since 5.2.0
 *
 ...
 * states the status of the context menu item.
 *
 * Since 5.2.0
 *
