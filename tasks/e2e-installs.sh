...
exists node_modules/create-cep-extension-scripts
grep '"version": "0.4.0"' node_modules/create-cep-extension-scripts/package.json
checkDependencies
...
cd "$temp_app_path"
create_react_app --scripts-version=https://registry.npmjs.org/create-cep-extension-scripts/-/create-cep-extension-scripts-0.4.0.tgz test-app-tarball-url
...
# ******************************************************************************
# Test --scripts-version with a custom fork of create-cep-extension-scripts
# ******************************************************************************

cd "$temp_app_path"
create_react_app --scripts-version=create-cep-extension-scripts-fork test-app-fork
cd test-app-fork

# Check corresponding scripts version is installed.
exists node_modules/create-cep-extension-scripts-fork
...
# ******************************************************************************
# Test --scripts-version with a scoped fork tgz of create-cep-extension-scripts
# ******************************************************************************

cd $temp_app_path
curl "https://registry.npmjs.org/@enoah_netzach/create-cep-extension-scripts/-/create-cep-extension-scripts-0.9.0.tgz" -o enoah-scripts-0.9.0.tgz
...
# Check corresponding scripts version is installed.
exists node_modules/@enoah_netzach/create-cep-extension-scripts
