...
You can find the most recent version of this guide [here](https://github.com/facebookincubator/create-react-app/blob/master/packages/create-cep-extension-scripts/template/README.md).
...
* `create-cep-extension-scripts` is a development dependency in the generated projects (including this one).

You almost never need to update `create-react-app` itself: it delegates all the setup to `create-cep-extension-scripts`.

When you run `create-react-app`, it always creates the project with the latest version of `create-cep-extension-scripts` so you’ll get all the new features and improvements in newly created apps automatically.

To update an existing project to a new version of `create-cep-extension-scripts`, [open the changelog](https://github.com/facebookincubator/create-react-app/blob/master/CHANGELOG.md), find the version you’re currently on (check `package.json` in this folder if you’re not sure), and apply the migration instructions for the newer versions.

In most cases bumping the `create-cep-extension-scripts` version in `package.json` and running `npm install` in this folder should be enough, but it’s good to consult the [changelog](https://github.com/facebookincubator/create-react-app/blob/master/CHANGELOG.md) for potential breaking changes.

We commit to keeping the breaking changes minimal so you can upgrade `create-cep-extension-scripts` painlessly.
...
>Note: this feature is available with `create-cep-extension-scripts@0.2.0` and higher.
...
-    "start": "create-cep-extension-scripts start",
-    "build": "create-cep-extension-scripts build",
+    "start-js": "create-cep-extension-scripts start",
+    "start": "npm-run-all -p watch-css start-js",
+    "build": "npm run build-css && create-cep-extension-scripts build",
     "test": "create-cep-extension-scripts test --env=jsdom",
...
>Note: this feature is available with `create-cep-extension-scripts@0.5.0` and higher.
...
>Note: this feature is available with `create-cep-extension-scripts@0.2.3` and higher.
...
>Note: this feature is available with `create-cep-extension-scripts@0.9.0` and higher.
...
>Note: this feature is available with `create-cep-extension-scripts@0.4.0` and higher.
...
>Note: this feature is available with `create-cep-extension-scripts@0.3.0` and higher.<br>
...
If you run `npm test` and the console gets stuck after printing `create-cep-extension-scripts test --env=jsdom` to the console there might be a problem with your [Watchman](https://facebook.github.io/watchman/) installation as described in [facebookincubator/create-react-app#713](https://github.com/facebookincubator/create-react-app/issues/713).
...
If you have ideas for more “How To” recipes that should be on this page, [let us know](https://github.com/facebookincubator/create-react-app/issues) or [contribute some!](https://github.com/facebookincubator/create-react-app/edit/master/packages/create-cep-extension-scripts/template/README.md)
