...
module.exports = function (appPath, appName, verbose, originalDirectory, template) {
  ...
  // which doesn't install react and react-dom along with create-cep-extension-scripts
  ...
  console.log()
  console.log(chalk.cyan(`  ${displayedCommand} ${useYarn ? '' : 'run '}archive`))
  console.log('    Creates a ZXP archive of the build to deploy to your extension users.')
  console.log()
