  ...
  .on('--help', () => {
    ...
    console.log(
      `      - a custom fork published on npm: ${chalk.green(
        'my-create-cep-extension-scripts'
      )}`
    );
    console.log(
      `      - a .tgz archive: ${chalk.green(
        'https://mysite.com/my-create-cep-extension-scripts-0.8.2.tgz'
      )}`
    );
    console.log(
    ...
    console.log(
      `      ${chalk.cyan(
        'https://github.com/fusepilot/create-cep-extension/issues/new'
      )}`
    );
    console.log();
  })
...
if (typeof projectName === 'undefined') {
  ...
  console.log(
    `  ${chalk.cyan(program.name())} ${chalk.green('my-cep-extension')}`
  );
  console.log();
  console.log(
